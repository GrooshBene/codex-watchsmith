...
Completion titles exclude known Desktop browser-context blocks and question-response envelopes. Confirmation-only inputs use the current answer topic instead of callback JSON or an older request. This is bounded text extraction, not semantic summarization.
